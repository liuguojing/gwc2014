...
<?php }?>
<p style="word-wrap:break-word;font-family:arial;"><a style="float:left;maring-left:500px;" href="<?php echo $this->domain;?>index.php/user/emailDinner?email=<?php echo $model->email;?>"><img src="https://app.corporate-reg.com/gwc2013/img/Amend.jpg" alt="Amend"/></a></p>
