...
<?php }?>
<p style="word-wrap:break-word;font-family:arial;"><a href="https://app.corporate-reg.com/gwc2013/index.php/user/emailDinner?email=<?php echo $model->email;?>">Amend</a></p>
