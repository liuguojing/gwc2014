			...
			<div class="navbar">
				<div class="navbar-inner">
					...
					<?php if(isset($this->user) && $this->user->status == 0){?>
						...
						<li<?php if($active == 'winner'){ echo ' class="active"';}?>><?php echo $step>1?CHtml::link('Sales Leaders Information',array('user/winner')):CHtml::link('Sales Leader Information','###');?></li>
