<div class="container top">
	<div class="row">
			<div class="span12" style="font-size:14px;">
				...
				<p><b>Thank you for registering for Winners Circle 2012 in Miami.</b></p>
				...
				<p>We look forward to seeing you in Miami!</p>
				<p style="margin-top:24px;">Winners Circle Events Team</P>
				<p style="margin-top:24px;">To see the agenda and learn more about the event, please <a href="http://www.gartnerwinnerscircle.com/miami/agenda/">click here</a> for the Winners Circle website using: User Name - gartner; Password - winners</p>
