<div class="container top">
	...
	<div class="row">
		<?php
			...
			if (date('y-m-d H:i:s',time()+57600)<date('y-m-d H:i:s',strtotime('14-05-10 00:00:00')) && $model->user->type=='Winners'){
		  ...
		  <div class="control-group">
		    <label class="control-label" for="User_headset">Gift Selection</label>
		       	...
		       	<?php foreach($gifts as $gift){?>
		         	...
		         	<hr/>
		         <?php }?>
    <?php  if (!(date('y-m-d H:i:s',time()+57600)<date('y-m-d H:i:s',strtotime('14-05-10 00:00:00')) && $model->user->type=='Winners')){ ?>      		         
		  <div class="control-group">
