<div class="container top">
	...
	<div class="row">
		<div class="span3"><a style="width:200px;background-color:#388cbb;background-image:-webkit-linear-gradient(top, #2aabe2, #388cbb);" href="<?php echo Yii::app()->request->baseUrl;?>/index.php/report/gift" class="btn btn-large btn-primary"><i class="icon-list-alt icon-white"></i> Onsite Gift</a><p></p></div>
		<div class="span3"><a style="width:200px;background-color:#388cbb;background-image:-webkit-linear-gradient(top, #2aabe2, #388cbb);" href="<?php echo Yii::app()->request->baseUrl;?>/index.php/report/ipad" class="btn btn-large btn-primary"><i class="icon-list-alt icon-white"></i> Onsite Ipad</a><p></p></div>
	</div>
	<?php }?>
</div>