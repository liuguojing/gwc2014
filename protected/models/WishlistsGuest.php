...
/**
 * This is the model class for table "wishlists_guests".
 *
 * The followings are the available columns in table 'wishlists_guests':
 * @property integer $id
 ...
 */
class WishlistsGuest extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, tour_id, seat_id, guest_id, order_date, ampm, created_at, created_by, updated_at, updated_by', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return WishlistsGuest the static model class
	 */
